...
golem::add_module(name = "module_2", with_test = FALSE) # Name of the module
golem::add_module(name = "GenerateSequence", with_test = FALSE) # Name of the module
...
## Vignette ----
usethis::use_vignette("group01DNAbuilder")
